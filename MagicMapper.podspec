#
#  Be sure to run `pod spec lint MagicMapper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "MagicMapper"
  s.version      = "1.0.0"
  s.summary      = "Super light and easy JSON to model mapper."
  ...
  # s.authors            = { "Adrian Mateoaea" => "adrianitech@gmail.com" }
